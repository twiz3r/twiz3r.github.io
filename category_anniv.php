...
<div id="wrapper">
	...
	<div id="featured-content">
		...
		<div id="border">
			...
			<div id="side_pannel">
				<ul>
					<li class="current_page_item"><a href="category_anniv.php">Anniversary</a></li>
...
<div id="border2">
			<h2>Anniversary</h2>
			<?php
                               	                $query = mysql_query("select * from prodmain_tbl where prod_category ='Anniversary' and prod_isdel = '0'");

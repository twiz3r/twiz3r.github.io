		...
		<div id="border">
			...
			<div id="side_pannel">
				<ul>
					...
					<li class="current_page_item"><a href="category_wedding.php">Wedding</a></li>
				</ul>
			</div>
		</div> <!-- end of border -->	
...
<div id="border2">
			<h2>Wedding</h2>
			<?php
                               	                $query = mysql_query("select * from prodmain_tbl where prod_category = 'Wedding' and prod_isdel = '0'");
...
</div><div id="footer-content-wrapper">

		...
		<div id="border">
			...
			<div id="side_pannel">
				<ul>
					...
					<li class="current_page_item"><a href="category_love.php">Love & Romance</a></li>
...
<div id="border2">
			<h2>Love & Romance</h2>
				<?php
                               	                $query = mysql_query("select * from prodmain_tbl where prod_category = 'Love & Romance' and prod_isdel = '0'");

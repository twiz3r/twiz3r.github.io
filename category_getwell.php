		...
		<div id="border">
			...
			<div id="side_pannel">
				<ul>
					...
					<li class="current_page_item"><a href="category_getwell.php">Get Well</a></li>
...
<div id="border2">
			<h2>Birthday</h2>
 			...
 			<?php
                               	                $query = mysql_query("select * from prodmain_tbl where prod_category = 'Get Well' and prod_isdel = '0'");

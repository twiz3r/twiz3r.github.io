		...
		<div id="border">
			...
			<div id="side_pannel">
				<ul>
					...
					<li class="current_page_item"><a href="category_thankyou.php">Thank You</a></li>
...
<div id="border2">
			<h2>Thank You</h2>
				<?php
                               	                $query = mysql_query("select * from prodmain_tbl where prod_category = 'Thank You' and prod_isdel = '0'");

		...
		<div id="border">
			...
			<div id="side_pannel">
				<ul>
					...
					<li class="current_page_item"><a href="category_birthday.php">Birthday</a></li>
...
<div id="border2">
			<h2>Birthday</h2>
 			...
 			<?php
                               	                $query = mysql_query("select * from prodmain_tbl where prod_category = 'Birthday' and prod_isdel = '0'");

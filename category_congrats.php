		...
		<div id="border">
			...
			<div id="side_pannel">
				<ul>
					...
					<li class="current_page_item"><a href="category_congrats.php">Congratulations</a></li>
...
<div id="border2">
			...
			<?php
                               	                $query = mysql_query("select * from prodmain_tbl where prod_category = 'Congratulations' and prod_isdel = '0'");

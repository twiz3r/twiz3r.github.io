		...
		<div id="border">
			...
			<div id="side_pannel">
				<ul>
					...
					<li class="current_page_item"><a href="category_sympathy.php">Sympathy</a></li>
					<li><a href="category_thankyou.php">Thank You</a></li>
					<li><a href="category_wedding.php">Weddings</a></li>
				</ul>
			</div>
		</div> <!-- end of border -->	
...
<div id="border2">
			<h2>Sympathy</h2>
				<?php
                               	                $query = mysql_query("select * from prodmain_tbl where prod_category = 'Sympathy' and prod_isdel = '0'");

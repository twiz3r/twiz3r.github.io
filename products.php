...
$sql = "SELECT * FROM prodmain_tbl LIMIT $start_from, $num_rec_per_page"; 
		...
		<div id="border">
			...
			<div id="side_pannel">
				<ul>
					...
					<li><a href="category_newbaby.php">New Baby</a></li>
			...
			<h2>All Products</h2>
			<?php
                               	                $query = mysql_query("select * from prodmain_tbl where prod_isdel = '0'");
												while($fetch = mysql_fetch_array($rs_result)) 
												{
...
$sql = "SELECT * FROM prodmain_tbl"; 
$rs_result = mysql_query($sql); //run the query
$total_records = mysql_num_rows($rs_result);  //count number of records
$total_pages = ceil($total_records / $num_rec_per_page); 

echo "PAGE<a href='products.php?page=1'>".'|<'."</a> "; // Goto 1st page  

for ($i=1; $i<=$total_pages; $i++) { 
            echo "<a href='products.php?page=".$i."'>".$i."</a> "; 
}; 
echo "<a href='products.php?page=$total_pages'>".'>|'."</a> "; // Goto last page
?>
		</span>
	</div>
</div>
